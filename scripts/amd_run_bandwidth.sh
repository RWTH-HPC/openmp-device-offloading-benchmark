...
export GPU_ARCH=mi250
sbatch --partition=mi250 --export=GPU_ARCH,USE_HIP,INCLUDE_ALLOC --output=${RES_DIR}/results_bw_mi250-hip-noalloc.txt amd_run_bandwidth.sbatch
export GPU_ARCH=mi210
sbatch --partition=mi210 --export=GPU_ARCH,USE_HIP,INCLUDE_ALLOC --output=${RES_DIR}/results_bw_mi210-hip-noalloc.txt amd_run_bandwidth.sbatch
