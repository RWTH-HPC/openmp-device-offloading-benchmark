...
sbatch --partition=c18g --gres=gpu:2 --account=supp0001 --export=GPU_ARCH,USE_CUDA --output=${RES_DIR}/results_lat_c18g.txt nvidia_run_latency.sbatch

# CLAIX 2023
export GPU_ARCH=sm_90
sbatch --partition=c23g --gres=gpu:2 --account=supp0001 --export=GPU_ARCH,USE_CUDA --output=${RES_DIR}/results_lat_c23g.txt nvidia_run_latency.sbatch
